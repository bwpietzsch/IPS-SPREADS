...
to setup
  ...
  set perceptdist (precision (random-float 6) 1)
  set moveangle (precision (random-float 90) 1)
  set diffusionrate (random 24)
...
<experiments>
  <experiment name="SA" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>perceptdist</metric>
    <metric>moveangle</metric>
    <metric>diffusionrate</metric>
    <metric>swarming</metric>
    <metric>winddirection</metric>
    <metric>windspeed</metric>
    <metric>meanenergy</metric>
    <metric>beetle_percentsucc1</metric>
    <metric>max_flightdist_inf1</metric>
    <metric>max_distance_host1</metric>
    <metric>mean_flightdist_inf1</metric>
    <metric>mean_distance_host1</metric>
    <metric>max_flightdist_all1</metric>
    <metric>mean_flightdist_all1</metric>
    <metric>mean_traveldist1</metric>
    <metric>max_traveldist1</metric>
    <metric>mean_airline1</metric>
    <metric>max_airline1</metric>
  ...
  <experiment name="A" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>perceptdist</metric>
    <metric>moveangle</metric>
  ...
  <experiment name="B" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>perceptdist</metric>
    <metric>moveangle</metric>
  ...
  <experiment name="C" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>perceptdist</metric>
    <metric>moveangle</metric>
  ...
  <experiment name="D" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>perceptdist</metric>
    <metric>moveangle</metric>
