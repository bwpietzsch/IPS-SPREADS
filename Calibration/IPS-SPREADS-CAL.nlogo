...
;  set generations (random 2 + 1)
;  set meanenergy (precision (random-float 8 + 6) 1)
;  set swarming (random 50 + 7)
...
to export-infestation-pattern
  ...
  if length (word behaviorspace-run-number) = 1 [
    gis:store-dataset export-raster (word path-to-output path-to-input 0 0 behaviorspace-run-number ".asc")
  ]
  if length (word behaviorspace-run-number) = 2 [
    gis:store-dataset export-raster (word path-to-output path-to-input 0 behaviorspace-run-number ".asc")
  ]
  if length (word behaviorspace-run-number) = 3 [
    gis:store-dataset export-raster (word path-to-output path-to-input behaviorspace-run-number ".asc")
  ]
...
@#$#@#$#@
<experiments>
  <experiment name="A" repetitions="200" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="B" repetitions="200" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>meanenergy</metric>
    <metric>swarming</metric>
  ...
  <experiment name="C" repetitions="200" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>meanenergy</metric>
    <metric>swarming</metric>
  ...
  <experiment name="D" repetitions="200" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>meanenergy</metric>
    <metric>swarming</metric>
